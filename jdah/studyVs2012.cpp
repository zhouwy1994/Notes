===========================================================================================
周武毅 2017年9月21日								Study On Visual Studio 2015
===========================================================================================
...
vs项目有大量代码时，通过项目管理器，新建筛选器添加代码是一件非常麻烦的事，我之前一直认为只有方式，还有一种直接托文件夹方式，
新建项目，右击项目，--->文件资源管理器中打开文件--->这时会弹出项目所在目录，将你的代码目录移动到这个目录下，点击菜单栏--->
